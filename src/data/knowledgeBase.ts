...
export const knowledgeSourceFiles: KnowledgeSourceFile[] = [
  ...
  {
    source: "Alur Pengajuan Sertifikasi Kegiatan Ormawa UKM.docx",
    fileName: "Alur Pengajuan Sertifikasi Kegiatan Ormawa UKM.docx",
    fileType: "application/vnd.openxmlformats-officedocument.wordprocessingml.document",
    fileUrl: "/knowledge-documents/alur-pengajuan-sertifikasi-kegiatan-ormawa-ukm.docx",
  },
  {
    source: "Syarat Pengajuan LPJ Kegiatan.docx",
    fileName: "Syarat Pengajuan LPJ Kegiatan.docx",
    fileType: "application/vnd.openxmlformats-officedocument.wordprocessingml.document",
    fileUrl: "/knowledge-documents/syarat-pengajuan-lpj-kegiatan.docx",
  },
  {
    source: "Syarat Pengajuan Proposal Dana Kegiatan.docx",
...
export const knowledgeSourceCount = 5;
export const knowledgeChunkCount = 10;
